...
| Claude | August 2026 | Claude Code `2.1.283` with Agent SDK `0.3.283` | `test:real-claude` (eleven files) | Local worker; persistent SSH or outbound sidecar on Linux/macOS |
