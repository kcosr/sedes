    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          // Panel matches the thread-actions menu language (Phase 4).
          "z-50 max-h-(--radix-dropdown-menu-content-available-height) min-w-[9rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-lg border border-border bg-popover p-[5px] text-popover-foreground shadow-[var(--shadow)]",
          className
        )}
        {...props}
      />
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        // Motion via styles.css data-slot keyframes; see dropdown-menu-content.
        "z-50 min-w-[9rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden rounded-lg border border-border bg-popover p-[5px] text-popover-foreground shadow-[var(--shadow)]",
        className
      )}
      {...props}
    />
