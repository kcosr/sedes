...
/**
 * The client's hand-rolled SVG brand marks.
 *
...
export const PiBrandIcon = ({
  ...
  <svg
    ...
    viewBox="47.93 165.29 704.15 586.79"
    width={size}
    {...props}
  >
    <path fill="#5B7190" d="M165.29 165.29H517.36V400H400V282.65H165.29Z" />
    <path
      fill="#A54E39"
      d="M165.29 282.65H282.65V400H400V517.36H282.65V634.72H165.29Z"
    />
    <path fill="#DE9851" d="M47.93 634.72H517.36V752.08H47.93Z" />
    <path fill="#A8AA7C" d="M517.36 400H634.72V634.72H752.08V752.08H517.36Z" />
  </svg>
);

export const CodexBrandIcon = ({
  size = 15,
  ...props
}: IconProps): React.JSX.Element => (
  <svg
 ...
 * `BackendBrand` enum: adding a protocol brand without registering its mark
 * is a compile error, so a defined brand always produces an element and
 * wrappers can rely on it (mirrors the server-side `BACKEND_BRANDS` record).
 * An absent brand (capability presentations may omit it) renders nothing.
 */
const BRAND_MARKS: Readonly<
  Record<BackendBrand, (props: IconProps) => React.JSX.Element>
> = {
  pi: PiBrandIcon,
...
export const BackendBrandIcon = ({
  ...
  return <Mark size={size} {...props} />;
};

export const SedesMark = ({
  size = 36,
}: {
  readonly size?: number;
}): React.JSX.Element => (
  <img alt="" draggable={false} height={size} src="/sedes-mark.png" width={size} />
);
