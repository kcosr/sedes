...
export class BackendConfigurationRepository {
            ...
            .prepare(
              `
                INSERT INTO agent_backend_instances(
                  tenant_id, owner_principal_id, id, kind, label, enabled,
  ...
  listBackends(scope: RequestScope): BackendInstanceRecord[] {
    return this.database
      ...
      .all(scope.tenantId, scope.principalId) as BackendInstanceRecord[];
  }
  ...
  #findBackend(
    ...
    return this.database
      ...
      .get(scope.tenantId, scope.principalId, backendId) as BackendInstanceRecord | undefined;
  }
  ...
  #assertReferencedConfigurationRetained(
    ...
    const referencedBackend = this.database
      ...
      .all(scope.tenantId, scope.principalId) as Array<{ id: string }>;
  ...
  #removeUnreferencedConfiguration(
    ...
    this.database
      ...
      .run(scope.tenantId, scope.principalId, ...backendIds);
